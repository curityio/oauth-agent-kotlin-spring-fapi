...
class TokenHandlerSpecification extends Specification {
    ...
    protected def getLoginStartURI() {
        if (loginStartUrl == null) {
            loginStartUrl = new URI("$baseUrl:$port/${configuration.bffEndpointsPrefix}$loginStartPath")
        }
    ...
    protected def getLoginEndURI() {
        if (loginEndUrl == null) {
            loginEndUrl = new URI("$baseUrl:$port/${configuration.bffEndpointsPrefix}$loginEndPath")
        }
